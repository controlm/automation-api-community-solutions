...
@Service
@IntentHandler(intent = Intent.SET_EVENT_TO_VALUE_INTENT)
@RequiredArgsConstructor
public class SetEventToValueIntentHandler extends AbstractRequestProcessor {
    ...
    public Optional<Response> defaultHandler(HandlerInput input, User user) {
        ...
        user.setUserVariables(UserVariables.EVENT_WITH_VAL_NAME);
