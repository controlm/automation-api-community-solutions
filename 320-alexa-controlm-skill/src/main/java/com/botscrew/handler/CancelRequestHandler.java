...
@Service
@IntentHandler(intent = Intent.CANCEL_INTENT)
@RequiredArgsConstructor
public class CancelRequestHandler extends AbstractRequestProcessor {
    ...
    public Optional<Response> defaultHandler(HandlerInput input, User user) {
        return alexaSimpleResponses.getAskResponse(messageHolder.getMessage(MessageKey.OK_YOUR_SESSION_HAS_BEEN_CANCELLED), input);
    }
