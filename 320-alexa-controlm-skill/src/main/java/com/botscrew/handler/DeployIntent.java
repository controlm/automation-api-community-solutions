...
@Service
@IntentHandler(intent = Intent.DEPLOY_INTENT)
@RequiredArgsConstructor
public class DeployIntent extends AbstractRequestProcessor {
    ...
    public Optional<Response> defaultHandler(HandlerInput input, User user) {
        userService.refreshUserField(user, user::setCurrentFileName);
        user.setUserVariables(UserVariables.FILE_NAME_DEPLOY);
