...
- The following table shows the correspondence between the HCTM and BHOM field names (aka "slots" in BHOM), plus additional information for fields which are modified in the script. For more information on the HCTM alert fields, check the [Alerts Template reference](https://docs.bmc.com/docs/saas-api/alerts-template-reference-1144242602.html) documentation.
