...
This Linux (bash) script extracts the alert data into individual variables.
...
- If you use the script as it is (saving JSON data into a file), update the **alerts_dir** and **alerts_file** variables with your custom file location.
