...
#
TID=`aws cloudtrail lookup-events --region us-west-2 --lookup-attributes AttributeKey=EventName,AttributeValue=TerminateInstances --start-time $PREVDAY --query 'Events[*].Resources[*].ResourceName' | grep i- | sed s/[^a-zA-Z0-9_-]//g`
