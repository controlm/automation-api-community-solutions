...
@Service
@IntentHandler(intent = Intent.RESOURCE_STATUS_INTENT)
@RequiredArgsConstructor
public class ResourceStatusIntentHandler extends AbstractRequestProcessor {
    ...
    public Optional<Response> defaultHandler(HandlerInput input, User user) {
        ...
        user.setUserVariables(UserVariables.RESOURCE);
