...
@Service
@IntentHandler(intent = Intent.RESOURCE_TO_VALUE_INTENT)
@RequiredArgsConstructor
public class SetResourceToValueIntentHandler extends AbstractRequestProcessor {
    ...
    public Optional<Response> defaultHandler(HandlerInput input, User user) {
        userService.refreshUserField(user, user::setCurrentResource);
        user.setUserVariables(UserVariables.RESOURCE_WITH_VAL);
