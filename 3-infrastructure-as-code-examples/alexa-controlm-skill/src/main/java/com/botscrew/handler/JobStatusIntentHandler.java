...
@Service
@IntentHandler(intent = Intent.JOB_STATUS_INTENT)
@RequiredArgsConstructor
public class JobStatusIntentHandler extends AbstractRequestProcessor {
    ...
    public Optional<Response> defaultHandler(HandlerInput input, User user) {
        ...
        user.setUserVariables(UserVariables.JOB_STATUS_NAME);
