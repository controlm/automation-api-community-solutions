...
@Service
@IntentHandler(intent = Intent.VALIDATE_THE_FILE_INTENT)
@RequiredArgsConstructor
public class ValidateFileIntentHandler extends AbstractRequestProcessor {
    ...
    public Optional<Response> defaultHandler(HandlerInput input, User user) {
        ...
        user.setUserVariables(UserVariables.FILE_NAME);
